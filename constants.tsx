...
import { LayoutDashboard, ShoppingCart, CreditCard, Box, FileBarChart, Droplets, Users } from 'lucide-react';
...
export const NAV_ITEMS = [
  ...
  { id: 'customers' as ViewType, label: 'Clientes', icon: <Users size={20} /> },
  { id: 'reports' as ViewType, label: 'Relatórios', icon: <FileBarChart size={20} /> },
];

export const INITIAL_INVENTORY = [
  { id: '1', name: 'Água 20L', quantity: 100, unit: 'un', minThreshold: 10, price: 500 },
  { id: '2', name: 'Água 5L', quantity: 100, unit: 'un', minThreshold: 10, price: 150 },
  { id: '3', name: 'Galões 20L Vazios', quantity: 150, unit: 'un', minThreshold: 20, price: 2500 },
  { id: '4', name: 'Lacres', quantity: 1000, unit: 'un', minThreshold: 100, price: 15 },
  { id: '5', name: 'Tampas', quantity: 800, unit: 'un', minThreshold: 50, price: 45 },
  { id: '6', name: 'Rótulos', quantity: 2000, unit: 'un', minThreshold: 200, price: 30 },
];
